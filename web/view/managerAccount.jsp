<%-- 
    ...
    Created on : Mar 13, 2022, 8:24:34 PM
    Author     : Admin
--%>
...
<!--        <script src="js/paggerA.js" type="text/javascript"></script>-->
...
<!--                                <th>Action</th>-->
                            ...
                            <c:forEach items="${listpage}" var="x">
                                <tr>
                                    ...
                                    <td><c:if test="${!x.isAdmin}">
                                            <button type="button" onclick="location.href = 'isadmin?id=${x.userId}&ia=true'" class="btn btn-primary">Grant permission</button>
                                        </c:if>
                                        <c:if test="${x.isAdmin}">
                                            <button type="button" onclick="location.href = 'isadmin?id=${x.userId}&ia=false'" class="btn btn-secondary">Remove permissions</button>
                                        </c:if>
                                    </td>
<!--                                    <td>                          
