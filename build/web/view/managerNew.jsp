...
<html lang="en">
    ...
    <head>
        ...
        <script src="js/paggerN.js" type="text/javascript"></script>       
                ...
                <div class="bottom-managerCoach">
                    <div class="container">
                        <div class="bottom1-managerCoach">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>There are ${totalnew} News</h3>
                                </div>
                                <div class="col-md-6">
                                    <a href="view/addNew.jsp" class="addCoach"><i style="font-size:20px" class="fa">&#xf196; Add
                                            New</i></a>
                                </div>
                            </div>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="UpdateN?id=${x.newId}" class="updateCoach"><i style="font-size:20px" class="fa">&#9756; Update
                                                New</i></a><br><br>
                                        <a href="DeleteN?id=${x.newId}" class="deleteCoach"><i style="font-size:21px" class="fa">&#xf014; Delete
                                                New</i></a>
                                    </td>
                                </tr>
                            </c:forEach>                       
